...
EntityBlock::EntityBlock(EventSystem &event_handler_, b2World &world, glm::vec2 position, glm::vec2 scale) {
	...
	textures[0] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("brick-2"));
	textures[1] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("brick-1"));
	textures[2] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("brick-0"));
