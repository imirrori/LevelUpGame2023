...
EntityCoin::EntityCoin(EventSystem &event_handler_, b2World &world, glm::vec2 position, glm::vec2 scale) {
	...
	textures[0] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("coin-0"));
	textures[1] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("coin-1"));
	textures[2] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("coin-2"));
	textures[3] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("coin-3"));
	textures[4] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("coin-4"));
	textures[5] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("coin-5"));
