...
EntityMushroom::EntityMushroom(EventSystem &event_handler, b2World &world, glm::vec2 position, glm::vec2 scale) {
	...
	run_texture[0] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("mushroom-run-0"));
	run_texture[1] = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("mushroom-run-1"));

	dead_texture = std::make_shared<Graphics::Texture>(Graphics::Texture::GetTexture("mushroom-dead"));
